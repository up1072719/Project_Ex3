...
Αν δεν γίνει χρήση της εφαρμογής μέσω docker container, θα πρέπει να τρέξει μαζί με έναν MQTT broker, οπως Eclipse Mosquitto, που θα ακούει στο port 1883.
